			...
			<div id="section3">
				...
				<div class="market_item">
					...
					<div class="market_item_name">
						...
						<form name="buy_start" method="post" action="../bbs/sl_core1_buy.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							<p>목걸이에 장착할 수 있는 코어잽입니다.</p>
							<p>장착할 시 깃들여져 있는 목걸이에 숨어 코어잽의 옵션을 발산시킵니다.</p><br>
							<p>옵션 정보</p>
