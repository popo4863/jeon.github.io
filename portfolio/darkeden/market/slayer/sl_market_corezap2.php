		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">얼음의 영혼이 깃든 조각</span></a>
				</div>
				<div class="market_item">
					<div class="item_image" style="padding:105px;">
						<img src="../item/core.png" width="100%" alt="아이템"/>
					</div>
					<div class="market_item_name">
						<h1>얼음의 영혼이 깃든 조각</h1>
						<p class="market_item_price">12,900원</p>
						<?php
							$user_id = $_SESSION['user_id'];
						...
						<form name="buy_start" method="post" action="../bbs/sl_core2_buy.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							<p>상의에 장착할 수 있는 코어잽입니다.</p>
							<p>장착할 시 깃들여져 있는 상의에 숨어 코어잽의 옵션을 발산시킵니다.</p><br>
							<p>옵션 정보</p>
							<p>HP흡수 + 6, 모든 능력치 + 20, 모든 저항력 + 9</p>
						</div>
					</div>
				</div>				
			</div>
