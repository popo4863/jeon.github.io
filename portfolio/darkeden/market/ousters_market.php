		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					...
					<a href="ousters_market.php"><span class="market_menu"style="font-weight:900;">아우스터즈</span></a>
					<a href="market_common.php"><span class="market_menu">공용</span></a>
				</div>
				
				<div class="market_item">
					<div class="item_image">
						<a href="ousters/ou_market_corezap1.php"><img src="item/core.png" width="160px" alt="도슬레이어"/></a>
						<p class="item_text"><a href="ousters/ou_market_corezap1.php">날카로운 티포쥬 조각</a></p>
						<p class="item_price"><a href="ousters/ou_market_corezap1.php">12 , 900원</a></p>
					</div>
					<div class="item_image">
						<a href="ousters/ou_market_corezap2.php"><img src="item/core.png" width="160px" alt="검슬레이어"/></a>
						<p class="item_text"><a href="ousters/ou_market_corezap2.php">얼음의 영혼이 깃든 조각</a></p>
						<p class="item_price"><a href="ousters/ou_market_corezap2.php">12 , 900원</a></p>
					</div>
					<div class="item_image">
						<a href="ousters/ou_market_do1.php"><img src="item/coin.png" width="160px" alt="도슬레이어"/></a>
						<p class="item_text"><a href="ousters/ou_market_do1.php">바토리의 천 돈</a></p>
						<p class="item_price"><a href="ousters/ou_market_do1.php">￦2 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="ousters/ou_market_do2.php"><img src="item/coin.png" width="160px" alt="검슬레이어"/></a>
						<p class="item_text"><a href="ousters/ou_market_do2.php">바토리의 오천 돈</a></p>
						<p class="item_price"><a href="ousters/ou_market_do2.php">5 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="ousters/ou_market_do3.php"><img src="item/coin.png" width="160px" alt="총슬레이어"/></a>
						<p class="item_text"><a href="ousters/ou_market_do3.php">바토리의 만 돈</a></p>
						<p class="item_price"><a href="ousters/ou_market_do3.php">￦10 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="market_loading.php"><img src="item/ousters1.png" width="160px" alt="총슬레이어"/></a>
						<p class="item_text"><a href="market_loading.php">전투  3옵션  호루스  패키지</a></p>
						<p class="item_price"><a href="market_loading.php">￦170 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="market_loading.php"><img src="item/ousters2.png" width="160px" alt="총슬레이어"/></a>
						<p class="item_text"><a href="market_loading.php">물  3옵션  호루스  패키지</a></p>
						<p class="item_price"><a href="market_loading.php">￦170 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="market_loading.php"><img src="item/ousters3.png" width="160px" alt="총슬레이어"/></a>
						<p class="item_text"><a href="market_loading.php">불  3옵션  호루스  패키지</a></p>
						<p class="item_price"><a href="market_loading.php">￦170 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="market_loading.php"><img src="item/ousters4.png" width="160px" alt="총슬레이어"/></a>
						<p class="item_text"><a href="market_loading.php">대지  3옵션  호루스  패키지</a></p>
						<p class="item_price"><a href="market_loading.php">￦170 , 000원</a></p>
					</div>
					<div class="item_image">
