		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">왕관의 핏빛 가호</span></a>
				</div>
				<div class="market_item">
					<div class="item_image" style="padding:105px;">
						<img src="../item/exp.png" width="152px" alt="아이템"/>
					</div>
					<div class="market_item_name">
						<h1>왕관의 핏빛 가호</h1>
						<p class="market_item_price">1,500원</p>
						<?php
							$user_id = $_SESSION['user_id'];
						...
						<form name="buy_start" method="post" action="../bbs/common_aura_exp.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							<p>1시간 30분동안 경험치 20%의 가호를 얻으실 수 있습니다</p><br><br>
							<p>─ 캐릭터 오오라 미리보기</p><br>
							<p><img src="../item/exp.gif" alt="아이템"/></p><br>
						</div>
					</div>
				</div>				
			</div>
