		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">질드레 코어잽 물리공격력</span></a>
				</div>
				<div class="market_item">
					...
					<div class="market_item_name">
						<h1 style="font-size:0.95em;">질드레 코어잽 물리공격력</h1>
						...
						<form name="buy_start" method="post" action="../bbs/common_corezap0.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
