		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">각성 오오라</span></a>
				</div>
				<div class="market_item">
					...
					<div class="market_item_name">
						...
						<form name="buy_start" method="post" action="../bbs/common_aura_buy2.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							...
							<p>─ 캐릭터 오오라 미리보기</p><br>
							<p><img src="../item/aura1.gif" alt="아이템"/></p><br>
						</div>
					</div>
				</div>				
			</div>
