		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">태양의 핏줄 오오라</span></a>
				</div>
				<div class="market_item">
					<div class="item_image" style="padding:105px;">
						<img src="../item/1.png" width="152px" alt="아이템"/>
					</div>
					<div class="market_item_name">
						<h1>태양의 핏줄 오오라</h1>
						<p class="market_item_price">7,000원</p>
						<?php
							$user_id = $_SESSION['user_id'];
						...
						<form name="buy_start" method="post" action="../bbs/common_aura_buy4.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							<p>자신의 캐릭터에 특별한 오오라를 부여할 수 있는 아이템입니다.</p><br><br>
							<p>─ 캐릭터 오오라 미리보기</p><br>
							<p><img src="../item/aura4.gif" alt="아이템"/></p><br>
						</div>
					</div>
				</div>				
			</div>
