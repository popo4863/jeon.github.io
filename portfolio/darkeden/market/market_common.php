		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					...
					<a href="vampire_market.php"><span class="market_menu">뱀파이어</span></a>
					<a href="ousters_market.php"><span class="market_menu">아우스터즈</span></a>					
					<a href="market_common.php"><span class="market_menu" style="font-weight:900;">공용</span></a>
				</div>
				
				<div class="market_item">
					<div class="item_image">
						<a href="common/common_aura.php"><img src="item/1.png" width="160px" alt="오오라"/></a>
						<p class="item_text"><a href="common/common_aura.php">혈기의 핏줄 오오라</a></p>
						<p class="item_price"><a href="common/common_aura.php">7 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_aura2.php"><img src="item/1.png" width="160px" alt="오오라"/></a>
						<p class="item_text"><a href="common/common_aura2.php">각성 오오라</a></p>
						<p class="item_price"><a href="common/common_aura2.php">7 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_aura3.php"><img src="item/1.png" width="160px" alt="오오라"/></a>
						<p class="item_text"><a href="common/common_aura3.php">검은 각성 오오라</a></p>
						<p class="item_price"><a href="common/common_aura3.php">7 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_aura4.php"><img src="item/1.png" width="160px" alt="오오라"/></a>
						<p class="item_text"><a href="common/common_aura4.php">태양의 핏줄 오오라</a></p>
						<p class="item_price"><a href="common/common_aura4.php">7 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_corezap0.php"><img src="item/core.png" width="160px" alt="코어잽"/></a>
						<p class="item_text"><a href="common/common_corezap0.php">질드레 코어잽 물리공격력</a></p>
						<p class="item_price"><a href="common/common_corezap0.php">25 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_corezap1.php"><img src="item/core.png" width="160px" alt="코어잽"/></a>
						<p class="item_text"><a href="common/common_corezap1.php">질드레 코어잽 마법공격력</a></p>
						<p class="item_price"><a href="common/common_corezap1.php">25 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_corezap2.php"><img src="item/core.png" width="160px" alt="코어잽"/></a>
						<p class="item_text"><a href="common/common_corezap2.php">질드레 코어잽 물리방어력</a></p>
						<p class="item_price"><a href="common/common_corezap2.php">25 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_corezap3.php"><img src="item/core.png" width="160px" alt="코어잽"/></a>
						<p class="item_text"><a href="common/common_corezap3.php">질드레 코어잽 마법방어력</a></p>
						<p class="item_price"><a href="common/common_corezap3.php">25 , 000원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_exp.php"><img src="item/exp.png" width="160px" alt="핏빛 가호"/></a>
						<p class="item_text"><a href="common/common_exp.php">왕관의 핏빛 가호</a></p>
						<p class="item_price"><a href="common/common_exp.php">1 , 500원</a></p>
					</div>
					<div class="item_image">
						<a href="common/common_corezap_upgrade.php"><img src="item/core.png" width="160px" alt="코어잽"/></a>
						<p class="item_text"><a href="common/common_corezap_upgrade.php">코어잽 업그레이드 코어</a></p>
						<p class="item_price"><a href="common/common_corezap_upgrade.php">4 , 000원</a></p>
					</div>					
				</div>				
			</div>
		</article>
