		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">바토리의 천 돈</span></a>
				</div>
				<div class="market_item">
					...
					<div class="market_item_name">
						<h1>바토리의 천 돈</h1>
						<p class="market_item_price">2,000원</p>
						<?php
							$user_id = $_SESSION['user_id'];
						...
						<form name="buy_start" method="post" action="../bbs/ou_coin1_buy.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							<p>바토리의 지갑에서 훔친 돈으로 NPC에게 건내주면 천 만원을 획득할 수 있습니다.</p>
						</div>
					</div>
				</div>				
			</div>
