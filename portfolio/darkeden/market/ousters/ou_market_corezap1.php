		...
		<article class="board">
			<div id="section3">
				<div class="market_menu_set">
					<span class="market_menu">날카로운 티포쥬 조각</span></a>
				</div>
				<div class="market_item">
					<div class="item_image" style="padding:105px;">
						<img src="../item/core.png" alt="아이템"/>
					</div>
					<div class="market_item_name">
						...
						<form name="buy_start" method="post" action="../bbs/ou_core1_buy.php" onsubmit="return login_submit(document.login_start);">
							<p>캐릭터 명</p>
					...
					<p>아이템 정보</p>
						<div class="market_item_information">
							<p>서클릿에 장착할 수 있는 코어잽입니다.</p>
							<p>장착할 시 깃들여져 있는 서클릿에 숨어 코어잽의 옵션을 발산시킵니다.</p><br>
							<p>옵션 정보</p>
